...
$.include('../Scripts/jquery.smoothmenu.min.js')
$.include('../Scripts/jflickrfeed.min.js');

if($('#showcase').length) {
	$.include('../Scripts/jquery.aw-showcase.min.js');
}
...
if($('#jplayer').length) {
	$.include('../Scripts/jquery.jplayer.min.js');
}
...
$.include('/Content/fancybox/jquery.fancybox.pack.js');
if($('#jstwitter').length) {$.include('../Scripts/twitter.js');}
if($('.star').length) {$.include('../Scripts/jquery.raty.min.js');}
if($('#scroll-pane').length) {$.include('../Scripts/jquery.mousewheel.min.js');}
if($('#scroll-pane').length) {$.include('../Scripts/jquery.jscrollpane.min.js');}
